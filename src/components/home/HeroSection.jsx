...
export const HeroSection = () => {
  ...
  className={`animate-none w-full md:max-w-[45%] h-[250px] md:h-[450px] border-purple-500 flex flex-col justify-center md:items-start items-center space-y-2`}>
        ...
        <span className={`text-sm md:text-base md:text-left text-center font-medium font-poppins ${isLoading && 'animate-pulse dark:bg-slate-500 bg-slate-300 rounded-md w-fit h-8 dark:text-transparent text-transparent'} dark:text-[#edf2f4] text-[#14213d]`}>by clicking the photos of wedding, event,adventure</span>
        <span className={`text-sm md:text-base md:text-left text-center font-medium font-poppins ${isLoading && 'animate-pulse dark:bg-slate-500 bg-slate-300 rounded-md w-fit h-8 dark:text-transparent text-transparent'} dark:text-[#edf2f4] text-[#14213d]`}>with pleasure and share with us.</span>
        <motion.button
        whileTap={{ scale: 0.7 }}
